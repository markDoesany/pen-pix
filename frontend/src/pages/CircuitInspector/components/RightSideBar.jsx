...
const RightSideBar = ({ task, file, circuitData, onGradeUpdate }) => {
  ...
  return (
    <div className={`bg-white flex flex-col gap-5 relative ${isCollapsed ? 'w-20 bg-black' : 'w-[300px]'} h-full px-5 text-textGray transition-all duration-300 ease-in-out`}>
